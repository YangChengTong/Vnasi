	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
			  ...
			  <dt>商品信息</dt>
				<dd><em><a href="<%=request.getContextPath()%>/ProductServlet?opr=selectFu">新增</a></em><a href="productClass.jsp">分类管理</a></dd>
	...
	<div class="main-wrap">
			...
			<div class="result-wrap">
				<div class="result-content">
					<form
						action="<%=request.getContextPath()%>/Vnasi_reviewServlet?opr=modifyReview"
