	...
	<div id="main" class="wrap">
		<div id="menu-mng" class="lefter">
			<div class="box">
				<dl>
					...
					<dd>
						<em><a href="<%=request.getContextPath()%>/ShoppingServlet?opr=insert">新增</a></em><a
		...
		<div class="main">
			...
			<form id="orderForm" method="post"
				action="<%=request.getContextPath()%>/Vnasi_orderServlet?opr=cha">
					...
					<table class="list">
						...
						<c:forEach items="${sessionScope.orderList }" var="order"
							...
							<tr>
								...
								<td><c:forEach items="${order.detail }" var="detail">
										<p>
											<img height="50px" width="50"
												src="<%=request.getContextPath()%>/files/${detail.product.ep_file_name }" />
								...
								<td>
									<form
										action="<%=request.getContextPath()%>/Vnasi_orderServlet?opr=modify&id=${order.eo_id }"
										method="post">
								...
								<td><a
									href="<%=request.getContextPath()%>/Vnasi_orderServlet?opr=index&index=${status.index }">查看详情</a>
								</td>
							</tr>
						</c:forEach>
					</table>
